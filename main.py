...
def main():
    while True:
        ...
        # Download YT song
        yt_to_sp_parser = subparsers.add_parser("download_yt_song", help="Download YouTube song to MP3.")
        yt_to_sp_parser.add_argument("song_name", help="Name of the Youtube song to download.")
        yt_to_sp_parser.add_argument("artists", help="Name of the artists associated with the song.")
